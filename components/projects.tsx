...
const Project = () => {
  ...
  const openweb = () => {
    const profileURL = "https://web-development-sepia.vercel.app/";
    window.open(profileURL, "_blank"); // opens LinkedIn profile
  };
  const openticwebsite = () => {
    const profileURL = "https://ticpau.vercel.app/";
    window.open(profileURL, "_blank"); // opens LinkedIn profile
  };
  return (
    <section id='projects' className=" overflow-hidden bg-white min-h-fit  max-w-7xl mx-auto px-4 md:px-24 py-24 w-full gap-24 flex items-center rounded-xl flex-col  justify-center">
        ...
        <div className='md:w-1/2 flex-col flex items-start justify-center gap-12'>
          ...
          <div className='flex-row max-md:w-full flex gap-4 items-center justify-center'>
            {languages.map((items, index) => (
              <div onClick= {openticwebsite} key={index} className='flex items-center justify-center'>
      ...
      <div className='md:w-1/2 flex-col flex items-start justify-center gap-12'>
          ...
          <div className='flex-row max-md:w-full flex gap-4 items-center justify-center'>
            {languages.map((items, index) => (
              <div key={index} className='flex items-center justify-center'>
                <div onClick={openweb} className='w-14 bg-gray-300 overflow-hidden aspect-square flex justify-center items-center rounded-full'>
                  <Image
          ...
          <div>
            <Link href="https://web-development-sepia.vercel.app/"
            target='_blank'>
            <Button >
              Live demo
            </Button>
      ...
      <div className='md:w-1/2 flex-col flex items-start justify-center gap-12'>
          <div className='flex flex-col gap-4 text-gray-600 font-semibold'>
            ...
            <p>
            Developing a student-focused mental health companion app designed to enhance access to emotional support through thoughtful UI design and AI-assisted interactions. The app features an intuitive interface, mood tracking, and chat functionalities, providing users with a seamless experience in managing their mental well-being.
                  </p>
          </div>
          <div className='flex-row-reverse max-md:w-full flex gap-4 items-center justify-center'>
            {languages.map((items, index) => (
              <div key={index} className='flex items-center justify-center'>
                <div onClick={openweb} className='w-14 bg-gray-300 overflow-hidden aspect-square flex justify-center items-center rounded-full'>
                  <Image
